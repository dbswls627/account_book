...
public interface sqlDao {
    ...
    @Query("INSERT INTO WatchSetting(amountGoal) VALUES(:amountGoal)")
    ...
    @Query("UPDATE WatchSetting SET amountGoal = :amountGoal")
    ...
    @Query("SELECT a.amountGoal FROM WatchSetting a")
